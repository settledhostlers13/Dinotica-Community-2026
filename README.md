...
# 🎮 Dinotica — Community Edition

**Survive among dinosaurs in a standalone offline build.**
...
Dinotica is an open-world dinosaur survival adventure set on a vast prehistoric island, combining exploration, crafting, and creature taming. This Community Edition is a standalone build distributed as a self-contained package that runs without a storefront or additional software. It includes all released content and supports full offline play.

PC players who want a self-contained, offline version of Dinotica with all content included.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3336520/ss_0f9e7c60348e2df355a218c00d3bd2f8f6af1bb8.1920x1080.jpg?t=1786692940" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3336520/fbd60898230aacd986689a9224096a3a60ec4175/ss_fbd60898230aacd986689a9224096a3a60ec4175.1920x1080.jpg?t=1786692940" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3336520/b1879aba049743ac76783141fbf0f5dd7e108df2/ss_b1879aba049743ac76783141fbf0f5dd7e108df2.1920x1080.jpg?t=1786692940" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🦖 **Open-World Island** — Explore a large prehistoric island filled with wildlife, caves, and ancient ruins.
- 🏕️ **Survival Mechanics** — Manage hunger, thirst, and body temperature across hostile terrain.
- 🛠️ **Crafting & Building** — Gather resources to craft tools, weapons, and permanent shelters.
- 🐾 **Creature Taming** — Befriend, feed, and ride dinosaurs to travel and defend your camp.
- 🌐 **LAN Multiplayer** — LAN or direct connection supported for cooperative sessions.
- 💾 **Self-Contained Package** — No storefront or additional software required to run the game.
- 🌧️ **Dynamic Weather** — Day-night cycle and weather systems directly affect survival conditions.
- 📴 **Offline Play** — The full single-player experience runs entirely offline.
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 960 4 GB / AMD Radeon RX 570 | NVIDIA GeForce RTX 2060 / AMD Radeon RX 5600 XT |
| **Storage** | 30 GB available space | 30 GB on an SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12, controllers supported |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Dinotica\Saved`
